...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--age_transfer_path',type=str, default='./checkpoints/age_trans_model/age_trans_model_0.pth')
        ...
        self.parser.add_argument('--no_cond_noise', action='store_true', default=False, help='remove gaussian noise from latent age code')

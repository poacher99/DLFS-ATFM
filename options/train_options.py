...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--print_freq', type=int, default=400, help='frequency of showing training results on console')
        self.parser.add_argument('--save_latest_freq', type=int, default=400, help='frequency of saving the latest results')
        self.parser.add_argument('--save_display_freq', type=int, default=400, help='save the current display of results every save_display_freq_iterations')
